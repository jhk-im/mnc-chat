...
class DefaultErrorFormatter @Inject constructor(
    ...
    private fun identityServerError(identityServiceError: IdentityServiceError): String {
        return stringProvider.getString(when (identityServiceError) {
            IdentityServiceError.OutdatedIdentityServer       -> R.string.template_identity_server_error_outdated_identity_server
            ...
            IdentityServiceError.BulkLookupSha256NotSupported -> R.string.template_identity_server_error_bulk_sha256_not_supported
